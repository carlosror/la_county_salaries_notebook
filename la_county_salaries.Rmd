...
##### 1.3.1 Errors in departments' names
...
1. L.A. County. (2017). ***LA County Employee Salaries*** [CSV]. Retrived from https://data.lacounty.gov/Operations/LA-County-Employee-Salaries/8rdv-6nb6

2. ScreechOwl and Ulrich, J. ***How to rename a single column in a data.frame?*** Retrived from http://stackoverflow.com/questions/7531868/how-to-rename-a-single-column-in-a-data-frame
